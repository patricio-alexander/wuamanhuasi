...
class Database{
    ...
    public function update_notas($tableName, $set, $where){
        try{
    ...
    public function update_contraseña($tableName, $set, $where){
    ...
    //Actualiza docente token y status para resetear contraseña
    public function update_docente_reset($tableName, $set, $where){
        try{
